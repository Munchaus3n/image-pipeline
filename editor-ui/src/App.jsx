...
export default function App({ onGoPipeline }) {
  ...
  async function doSave() {
    ...
    try {
      ...
      const result = await saveComposition(payload, srcFolder, queueIdx, comboMode);
      setSaved(true);
    ...
    >
      ...
      <div style={{ padding:"12px 8px 12px 12px", display:"flex", flexDirection:"column", gap:8 }}>
        ...
        <canvas
          ...
          style={{ border:`1px solid ${C.border}`, cursor:"crosshair", display:"block", borderRadius:2 }}
        />
